...
class Parameters:
    __slots__=["plasma_r_displ", "plasma_z_displ", "wall_silh_r_displ",
               ...
               "lambda_q_near", "R_q", "R_breakpoint", "rd_ip_transition",
    ...
    def __init__(self):
        ...
        # radians.
        self.time_end = 1.0 # Toroidal radians
        # Time step is the resolution at which the solver checks the FL path
        # for intersections
        self.time_step = 0.01 # Toroidal resolution for solver
        ...
        # data to meters
        self.target_dim_mul = 1e-3 # Shadow dimension multiplier
        ...
        # factor.
        self.shadow_dim_mul = 1000 # Shadow dimension multiplier
        self.num_of_threads = 1

        # Plasma profile parameters
        self.side = "iwl" # or "owl"

        # Classical Power at sol
        self.P_sol = 1.0
        self.F_split = 0.5
        # Not so classical, we have the q_parallel calculated
        ...
        self.R_q = 1
        self.R_breakpoint = 0.05

        # Ramp down transition
        self.rd_ip_transition = 10e6
        self.cutoff_conlen = 4.3e3 # 4.3 meters
        self.r_break = 0.025
