def main():
    ...
    parser.add_argument('-b', '--backend',
                        metavar="BACKEND", type=str, default="mdsplus", help='Backend (hdf5 or mdsplus)')
    ...
    uri = f"imas:{args.backend}?database={args.device};shot={args.shot};run={args.run};user={args.user};version={args.version}"
    ids = imas.DBEntry(uri, 'r')
    summary = ids.get("summary", autoconvert=False)
